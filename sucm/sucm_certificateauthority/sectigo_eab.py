...
class Sectigo_EAB(SucmCertificateAuthority):
    def __init__(self):
        self.eab_directory = sectigo_eab_config["eab_directory"]
        self.eab_kid = sectigo_eab_config["eab_kid"]
        self.eab_hmac = sectigo_eab_config["eab_hmac"]
        self.eab_user_agent = sectigo_eab_config["eab_user_agent"]
        self.eab_email = sectigo_eab_config["eab_email"]
        self.eab_account_pw = sectigo_eab_config["eab_account_pw"]

        with open("/local/cert-app/SECTIGO_EAB_account_key.pem", "rb") as key_file:
